Pod::Spec.new do |s|
  ...
  s.summary  = 'This is a forked copy of PocketSocket designed to work with the BEREC nntool ias-ios module.'
  ...
  s.homepage = 'https://github.com/net-neutrality-tools/PocketSocket'
  s.authors  = { 'Robert Payne' => 'robert@zwopple.com', 'alladin-zafaco' => 'berec@alladin.at' }
  s.source   = { :git => 'https://github.com/net-neutrality-tools/PocketSocket.git', :tag => '1.0.1', :submodules => false }
  s.requires_arc = true
